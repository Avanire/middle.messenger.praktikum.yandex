    ...
    render(): string {
        return `
            <form action="" class="conversation__footer conversation-footer" enctype="multipart/form-data">
                    ...
                    <div class="conversation-footer__attach-menu attach-menu">
                        <label for="photo">
                            <span class="attach-menu__item">
                                ...
                                <span class="attach-menu__text">Фото или Видео</span>
                            </span>
                            <input accept="image/gif,image/jpeg,image/jpg,image/png"  multiple="" type="file" style="display: none;" id="photo" name="photo">
                        </label>
                        <label for="file">
                            <span class="attach-menu__item">
                                <img src="${fileIcon}" alt="">
                                <span class="attach-menu__text">Файл</span>
                            </span>
                            <input accept="*" type="file" multiple="" style="display: none;" id="file" name="file">
                        </label>
                    </div>
                </div>        
                ...
                {{{ ArrowButton id='conversation-footer__submit' type='submit' }}}
            </form>
        `;
    }
}
